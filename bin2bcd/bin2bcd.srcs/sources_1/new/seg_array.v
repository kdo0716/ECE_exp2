...
output reg [7:0] seg_sel; //which digit to control
reg [3:0] bcd;
/*
oneshot_universal #(.WIDTH(1)) 01(clk, rst, btn, btn_trig);
*/
bin2bcd B1(clk, rst, state_bin[3:0], state_bcd[7:0]);

always @(posedge clk or negedge rst) begin //increase 1 state when I push the button
...
//select output JARITSU
always @(*) begin
    case(seg_sel)
        8'b11111110 : bcd = state_bcd[3:0]; //1's digit
        8'b11111101 : bcd = state_bcd[7:4]; //10's digit
        8'b11111011 : bcd = 4'b0000; //100's digit
