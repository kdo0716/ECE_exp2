...
HD_PWD='C:/Users/82109/JJS2/ECE_exp2/Adder/Adder.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log HA_case.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source HA_case.tcl -notrace
