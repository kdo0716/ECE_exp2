...
HD_PWD='C:/Users/82109/JJS2/ECE_exp2/priority_encoder4x2/priority_encoder4x2.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log priority_encoder4x2.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source priority_encoder4x2.tcl
