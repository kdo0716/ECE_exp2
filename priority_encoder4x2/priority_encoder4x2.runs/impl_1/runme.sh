...
HD_PWD='C:/Users/82109/JJS2/ECE_exp2/priority_encoder4x2/priority_encoder4x2.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log priority_encoder4x2.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source priority_encoder4x2.tcl -notrace
