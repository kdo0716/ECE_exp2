...
HD_PWD='C:/Users/82109/JJS2/ECE_exp2/decoder3x8/decoder3x8.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log decoder3x8.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source decoder3x8.tcl -notrace
